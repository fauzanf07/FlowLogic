let kj_id = [2,5,2,3,4,3,1,2,3,3,3];
let xp = 0;
let points =0;
let benar=0;
let salah=0;
...
function result(jml, user){
    ...
    updateHistory(user,2,xp,"Kamu telah menyelesaikan Quiz Singkat 3");
    updateHistory(user,4,points,"Kamu telah menyelesaikan Quiz Singkat 3");
