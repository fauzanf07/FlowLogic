				...
				<ul class="navbar-nav ms-auto">
					...
					<div class="btn-group dropdown-center">
						...
						<ul class="dropdown-menu">
							<li><span class="dropdown-item"><i class="bi bi-diamond-fill"></i>&nbsp;&nbsp; 500
									Points</span></li>
							<li><span class="dropdown-item"><i class="bi bi-star-fill"></i>&nbsp;&nbsp; 1000 XP</span>
							</li>
							<li><span class="dropdown-item"><i class="bi bi-capslock-fill"></i>&nbsp;&nbsp; Level
									3</span></li>
							<li>
		...
		<div class="row">
			...
			<div class="col-lg-8 side-right order-lg-2 corder-md-1">
				<div class="right-content">
					<p>Merancang flowchart merupakan sebuah proses yang tidak memiliki aturan baku yang harus diikuti secara ketat. Hal ini dikarenakan flowchart dibuat berdasarkan pemikiran untuk menganalisis masalah dalam bisnis. Namun, penting bagi kita untuk memahami simbol-simbol standar yang umum digunakan dalam pembuatan flowchart agar dapat merancangnya dengan baik. Mari kita jelaskan mengenai simbol-simbol flowchart yang terbagi ke dalam tiga kategori diantaranya.</p>

					<ol>
						<h4><li>Simbol Arus (<i>Flow Direction Symbols</i>) </li></h4>
						<p>Simbol-simbol dalam kategori ini umumnya digunakan sebagai simbol penghubung. Beberapa simbol yang masuk dalam kategori ini meliputi:</p>
						<table class="table">
							<thead>
								<tr>
							...
							<tbody>
								<tr>
									...
									<td>Flow Direction Symbol / Connecting Line</td>
									<td>Berfungsi untuk menghubungkan simbol yang satu dengan yang lainnya, menyatakan arus suatu proses.</td>
								</tr>
								<tr>
									<td><img src="../images/simbol/communication-link.png" alt=""></td>
									<td>Communication Link</td>
									<td>Berfungsi untuk transmisi data dari satu lokasi ke lokasi lain.</td>
								</tr>
								<tr>
									<td><img src="../images/simbol/connector.png" alt=""></td>
									<td>Connector</td>
									<td>Digunakan untuk menyatakan sambungan dari proses yang satu ke proses berikutnya di halaman yang sama.</td>
								</tr>
								<tr>
									<td><img src="../images/simbol/offline-connector.png" alt=""></td>
									<td>Offline Connector</td>
									<td>Digunakan untuk menyatakan sambungan dari proses yang satu ke proses berikutnya di halaman yang berbeda.</td>
								</tr>
							</tbody>
						</table>
						<h4><li>Simbol Proses (<i>Processing Symbols</i>) </li></h4>
						<p>Seperti namanya, simbol proses digunakan untuk menunjukkan simbol-simbol yang terkait dengan serangkaian proses yang dilakukan. Berikut adalah beberapa simbol yang termasuk dalam kategori proses:</p>
						<table class="table">
							<thead>
								<tr>
								<th scope="col">Simbol</th>
							...
							<tbody>
								...
								<tr>
									<td><img src="../images/simbol/manual-operation.png" alt=""></td>
									<td>Manual Operation</td>
									<td>Digunakan untuk menunjukkan perngolahan yang tidak dilakukan oleh komputer.</td>
								</tr>
								<tr>
								...
								<tr>
									<td><img src="../images/simbol/predefined-process.png" alt=""></td>
									<td>Predefined Process</td>
									<td>Digunakan untuk mempersiapkan penyimpanan yang sedang/akan digunakan dengan memberikan harga awal.</td>
								</tr>
								<tr>
								...
								<tr>
									<td><img src="../images/simbol/offline-storage.png" alt=""></td>
									<td>Offline Storage</td>
									<td>Berfungsi untuk menunjukkan bahwa data akan disimpan ke media tertentu.</td>
								</tr>
								<tr>
						...
						<h4><li>Simbol I/O (<i>Input-Output</i>) </li></h4>
						<p>Simbol-simbol yang termasuk dalam kategori input-output berkaitan dengan masukan dan keluaran. Berikut adalah beberapa simbol yang termasuk dalam kategori tersebut.</p>
						<table class="table">
							<thead>
								<tr>
								<th scope="col">Simbol</th>
							...
							<tbody>
								...
								<tr>
									<td><img src="../images/simbol/punched-card.png" alt=""></td>
									<td>Punched Card</td>
									<td>Digunakan untuk menyatakan masukan dan keluaran yang berasal dari card.</td>
								</tr>
								<tr>
									<td><img src="../images/simbol/disk-storage.png" alt=""></td>
									<td>Disk Storage</td>
									<td>Digunakan untuk menyatakan masukan dan keluaran yang berasal dari disk.</td>
								</tr>
								<tr>
									<td><img src="../images/simbol/magnetic-tape.png" alt=""></td>
									<td>Magnetic Tape</td>
									<td>Digunakan untuk menyatakan masukan dan keluaran yang berasal dari pita magnetis.</td>
								</tr>
								<tr>
									<td><img src="../images/simbol/document.png" alt=""></td>
									<td>Document</td>
									<td>Digunakan untuk menyatakan masukan dan keluaran yang berasal dari dokumen.</td>
								</tr>
								<tr>
									<td><img src="../images/simbol/display.png" alt=""></td>
									<td>Display</td>
									<td>Digunakan untuk menyatakan keluaran melalui layar monitor.</td>
								</tr>
							</tbody>
						</table>
					</ol>
