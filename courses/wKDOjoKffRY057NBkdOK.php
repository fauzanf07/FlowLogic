		...
		<div class="row">
			...
			<div class="col-lg-8 side-right order-lg-2 corder-md-1">
				<div class="right-content">
					...
					<button class="btn btn-course f-right" id="next" data-next="3" data-curr="<?php echo $currCourse ?>" data-reward='0' data-username="<?php echo $_SESSION['username']; ?>">Berikutnya</button>
				</div>
			</div>
		</div>
	</div>
