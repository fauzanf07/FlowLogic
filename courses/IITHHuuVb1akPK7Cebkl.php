...
<head>
    <title>Pemanggilan Prosedur</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 side-right order-lg-2 corder-md-1">
                <div class="right-content">
                    <h4>Pemanggilan Prosedur</h4>
                    <p>Sama seperti fungsi juga, ada dua cara untuk melewatkan parameter ke dalam prosedur, yaitu berupa:</p>
                    <ul>
                    ...
                    <ol>
                        ...
                        <p>Dalam pemanggilan by value, nilai dari argumen yang diteruskan akan disalin ke parameter prosedur. Dalam hal ini, meskipun nilai parameter prosedur berubah, nilai argumen asli tidak akan terpengaruh. Perhatikan program berikut.</p>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
...
void updateValue(int num) {
    num = num + 10;  // Modifikasi nilai parameter
    printf("Nilai dalam prosedur: %d\n", num);
}

int main() {
    int value = 5;
    printf("Nilai sebelum pemanggilan prosedur: %d\n", value);
    updateValue(value);
    printf("Nilai setelah pemanggilan prosedur: %d\n", value);
    ...
    return 0;
                        ...
                        <p>Dalam contoh ini, kita memiliki prosedur <code>updateValue</code> yang memiliki parameter <code>num</code> berupa bilangan bulat. Pada pemanggilan prosedur, kita menambahkan nilai parameter dengan 10. Namun, setelah pemanggilan prosedur, nilai variabel <code>value</code> dalam fungsi <code>main</code> tidak berubah karena pemanggilan dilakukan dengan mekanisme "by value".</p>
                        <h5><li>Pemanggilan dengan Referensi</li></h5>
                        <p>Pemanggilan dengan referensi merupakan suatu metode di mana alamat variabel dikirimkan ke dalam suatu prosedur. Dengan menggunakan pendekatan ini, kita dapat memodifikasi nilai variabel yang ada di luar prosedur dengan melakukan perubahan pada variabel tersebut di dalam prosedur tersebut. Contoh program berikut dapat menjelaskan konsep ini.</p>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <select class="form-select lang-list" aria-label="Default select example">
...
void changeValue(int *num) {
    *num = 100;  // Mengubah nilai variabel di luar prosedur
}

int main() {
    int number = 50;
    
    printf("Sebelum pemanggilan prosedur: %d\n", number);
    
    changeValue(&number);  // Pemanggilan prosedur dengan referensi
    
    printf("Setelah pemanggilan prosedur: %d\n", number);
    ...
    return 0;
                        ...
                        <p>Pada contoh di atas, terdapat prosedur <code>changeValue</code> yang menerima parameter berupa pointer <code>(int *num)</code>. Dalam prosedur tersebut, nilai variabel yang ditunjuk oleh pointer tersebut diubah menjadi 100.</p>
                        <p>Ketika prosedur <code>changeValue</code> dipanggil dari dalam <code>main</code>, kita mengirimkan alamat variabel <code>number</code> menggunakan operator <code>& (&number)</code>. Dengan demikian, prosedur dapat mengakses dan mengubah nilai variabel tersebut langsung di memori.</p>
                        <p>Output program di atas akan menunjukkan bahwa nilai variabel number telah berubah setelah pemanggilan prosedur dengan referensi.</p>
                    </ol>
                    <div style="clear:both;"></div>
                    <button class="btn btn-course" id="previous" data-prev="23">Sebelumnya</button>
                    <button class="btn btn-course f-right" id="next" data-next="25"
                        data-curr="<?php echo $currCourse ?>" data-reward='0'
                        data-username="<?php echo $_SESSION['username']; ?>" data-user="<?php echo $idUser; ?>"
                        data-materi="Pemanggilan Prosedur" data-artikel="1">Berikutnya</button>
                </div>
            </div>
        </div>
    </div>
