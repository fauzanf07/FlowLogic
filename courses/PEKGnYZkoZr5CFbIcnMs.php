...
void cetakPesan() {
    printf("Halo, ini adalah pesan dari prosedur!\n");
                    ...
                    <button class="btn btn-course" id="previous" data-prev="21">Sebelumnya</button>
                    <button class="btn btn-course f-right" id="next" data-next="23"
                        data-curr="<?php echo $currCourse ?>" data-reward='0'
                        data-username="<?php echo $_SESSION['username']; ?>" data-user="<?php echo $idUser; ?>"
                        data-materi="Struktur Prosedur" data-artikel="1">Berikutnya</button>
                </div>
            </div>
        </div>
    </div>
