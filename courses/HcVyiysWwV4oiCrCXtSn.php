                ...
                <div class="right-content">
                    ...
                    <ol>
                        ...
                        <ul>
                            ...
                            <li><b>Paramerer Formal : </b>Variabel yang tercantum dalam daftar parameter saat mendefinisikan sebuah fungsi. Parameter aktual merujuk pada nilai yang sebenarnya dilewatkan atau dikirim ke fungsi atau prosedur saat memanggilnya. Nilai-nilai ini kemudian akan diterima oleh parameter formal dan digunakan di dalam tubuh fungsi atau prosedur. Terdapat tiga tipe parameter formal yakni : </li>
                            <ol>
                                <li>Parameter masukan (input), merupakan argumen yang dibutuhkan oleh suatu prosedur sebagai input untuk menjalankan aksi yang efektif.</li>
                                <li>Parameter keluaran (output), adalah argumen yang digunakan untuk menyimpan nilai yang dihasilkan oleh prosedur.</li>
                                <li>Parameter masukan/keluaran adalah argumen yang diperlukan oleh prosedur sebagai input untuk melakukan aksi tertentu. Nilai argumen tersebut akan diisi dengan nilai baru sebagai hasil eksekusi prosedur.</li>
                            </ol>
                        </ul><br>
